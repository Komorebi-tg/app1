...
public interface PostDao {
    ...
    @Query("SELECT * FROM post WHERE category = :category AND saved")
    List<Post> getSavedPosts(String category);
    ...
    @Query("UPDATE post SET saved = :saved WHERE uid = :uid")
    void setSaved(long uid, boolean saved);
